...
object Gen extends App {
  ...
  def f1(v0: Double): Double = {
    var v1: Double = v0
    var v6: Double = v1
    val v3: Vector[Double] = Vector(v1, v6, v0, v6, v6)
