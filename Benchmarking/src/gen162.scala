...
object Gen extends App {
  ...
  def f25(v0: s1, v1: s1): s1 = {
    val v7: Vector[Vector[s0]] = v0.p1
    val v3: Vector[Vector[s0]] = v1.p0
    var v5: Vector[Vector[s0]] = v3
    val v9: Vector[s0] = v7(2)
    var v8: Vector[Vector[s0]] = v7
    v5 = v5.updated(0, v9)
    var v6: s1 = v0
    v8 = v8.updated(0, v9)
    val v13: Vector[s0] = v7(1)
    val v19: Vector[Vector[s0]] = v0.p1
    val v21: Vector[Vector[s0]] = v6.p0
    v5 = v5.updated(0, v13)
    val v11: Vector[Vector[s0]] = v1.p1
    val v12: Vector[Vector[s0]] = v1.p1
    var v24: Vector[Vector[s0]] = v8
    var v10: s1 = v0
    val v14: Vector[Vector[Vector[s0]]] = Vector(v12, v8, v24, v12, v8, v24, v24)
    v24 = v24.updated(0, v13)
    val v15: Vector[Vector[s0]] = v6.p0
    var v18: s1 = v1
    v5 = v5.updated(0, v9)
    v6 = v6.copy(p1 = v11)
    var v35: Vector[Vector[s0]] = v24
    var v25: Vector[Vector[s0]] = v5
    v18 = v18.copy(p1 = v11)
    v10 = v10.copy(p0 = v15)
    var v29: Vector[s0] = v13
    v6 = v6.copy(p1 = v35)
    val v39: Vector[Vector[s0]] = v0.p1
    val v27: Vector[Vector[s0]] = v0.p1
    val v41: Vector[s1] = Vector(v0)
    val v33: s1 = v41(0)
    val v30: Vector[Vector[s0]] = v10.p1
    v25 = v25.updated(0, v9)
    v10 = v10.copy(p0 = v3)
    v8 = v8.updated(1, v13)
    val v40: Vector[Vector[s0]] = v6.p1
    val v26: Vector[Vector[s0]] = v1.p0
    v18 = v18.copy(p0 = v25)
    v10 = v10.copy(p1 = v40)
    v5 = v5.updated(0, v9)
    val v42: Vector[s0] = v35(1)
    val v34: Vector[Vector[s0]] = v33.p0
    val v49: Vector[s0] = v25(0)
    v25 = v25.updated(0, v29)
    val v51: s1 = v41(0)
    val v46: Vector[Vector[s0]] = v14(2)
    v18 = v18.copy(p1 = v30)
    val v81: Vector[Vector[s0]] = v10.p0
    v10 = v10.copy(p0 = v25)
    v6 = v6.copy(p0 = v25)
    val v36: s1 = s1(v15, v46)
    val v71: Vector[Vector[s0]] = v18.p0
    val v155: s1 = s1(v15, v39)
    v5 = v81
    v8 = v8.updated(0, v49)
    val v38: Vector[s0] = v8(2)
    val v31: Vector[s0] = v71(0)
    val v50: Vector[Vector[s0]] = Vector(v38, v38, v49, v49)
    v25 = v25.updated(0, v9)
    val v122: Vector[s0] = v50(2)
    var v58: s1 = v155
    v58 = v58.copy(p0 = v71)
    val v64: Vector[s0] = v50(3)
    v58 = v58.copy(p1 = v40)
    v5 = v5.updated(0, v122)
    v6 = v58
    v10 = v10.copy(p0 = v21)
    v24 = v24.updated(0, v64)
    v18 = v18.copy(p1 = v7)
    val v67: Vector[Vector[s0]] = v51.p0
    v24 = v24.updated(1, v42)
    v58 = v58.copy(p1 = v19)
    val v161: Vector[s0] = v3(0)
    v58 = v58.copy(p0 = v34)
    v35 = v35.updated(0, v31)
    val v60: s0 = v161(0)
    v29 = v29.updated(0, v60)
    v6 = v6.copy(p1 = v30)
    v10 = v10.copy(p0 = v3)
    v5 = v5.updated(0, v9)
    v58 = v58.copy(p0 = v26)
