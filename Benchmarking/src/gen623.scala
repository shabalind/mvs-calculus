...
object Gen extends App {
  ...
  @noinline
  def f0(v0: Vector[s6], v1: Vector[s5], v2: Double): Double = {
    val v3: s6 = v0(0)
    val v10: Vector[s2] = v3.p0
    var v15: Vector[s2] = v10
    val v12: s2 = v15(0)
