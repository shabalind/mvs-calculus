...
object Gen extends App {
  ...
  @noinline
  def f0(v0: s1, v1: Vector[s2], v2: s1, v3: Vector[s2], v4: Vector[Vector[s0]], v5: s8, v6: Double): Double = {
    val v13: s2 = v1(2)
    var v11: Double = v6
    val v10: Double = v11 / v6
    val v29: s0 = v13.p1
    val v32: Vector[Vector[Double]] = v29.p0
    val v58: Vector[Double] = v32(0)
    val v38: Double = v58(0)
    val v46: Double = v10 + v38
    var v81: Double = v46
    val v110: Double = v81 + v6
    val v108: Double = v110 * v110
    v108
  }
  def benchmark(): Unit = {
