  ...
  struct s3 {
    ...
    s2 p1;
    s0 p2;
    s3(std::vector<s1> v0, s2 v1, s0 v2): p0(v0), p1(v1), p2(v2) { }
  };
  struct s4 {
  ...
  double f0(const std::vector<std::vector<s1>> &v0, const s4 &v1, const std::vector<std::vector<s1>> &v2, const double &v3) {
    const std::vector<s1> v5 = v2[0];
    double v11 = v3;
    const s1 v4 = v5[0];
    const double v24 = v11 - v11;
    double v19 = v24;
    const double v43 = v24 * v19;
    const s0 v25 = v4.p1;
    const std::vector<std::vector<double>> v35 = v25.p1;
    const std::vector<double> v48 = v35[0];
    const double v32 = v48[0];
    const double v100 = v43 / v32;
    double v130 = v100;
    return v130;
  }
  int main() {
    ...
    std::vector<std::vector<s1>> v2({ { { { { { { { 255.0 } }, { { 256.0 } }, { { 257.0 }, { 258.0 } }, { { 259.0 } } } }, { { { { 260.0 } }, { { 261.0 } }, { { 262.0 }, { 263.0 } }, { { 264.0 } } } } }, { { { 265.0 } }, { { 266.0 } }, { { 267.0 }, { 268.0 } }, { { 269.0 } } } } } });
    double v3(270.0);
