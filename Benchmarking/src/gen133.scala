...
object Gen extends App {
  ...
  @noinline
  def f0(v0: Vector[Vector[s2]], v1: s4, v2: s2, v3: Double): Double = {
    var v16: Double = v3
    val v25: Double = v3 / v16
    var v17: Double = v16
    v17 = v25
    val v100: Vector[Double] = Vector(v3, v17, v25)
    val v193: Double = v16 * v3
    var v135: Vector[Double] = v100
    v135 = v135.updated(2, v25)
    val v101: Double = v135(0)
    val v144: Double = v101 * v193
    v144
  }
  def benchmark(): Unit = {
