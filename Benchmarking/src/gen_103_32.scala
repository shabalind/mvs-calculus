...
object Gen extends App {
  ...
  @noinline
  def f0(v0: s2, v1: Vector[s2], v2: s9, v3: s11, v4: Double): Double = {
    val v5: Vector[s6] = v3.p0
    val v9: s6 = v5(0)
    var v7: s6 = v9
    val v20: Vector[s2] = v9.p0
    v7 = v7.copy(p0 = v20)
    val v43: s0 = v7.p1
    v7 = v7.copy(p0 = v20)
    val v21: Vector[Vector[Double]] = v43.p0
    val v40: Vector[Double] = v21(0)
