...
object Gen extends App {
  ...
  @noinline
  def f0(v0: Vector[Vector[s0]], v1: Vector[s3], v2: Vector[s3], v3: Vector[s0], v4: Vector[Vector[s0]], v5: s2, v6: Vector[Vector[s3]], v7: Double): Double = {
    val v19: s3 = v2(0)
    val v36: s3 = f11(v19)
    val v94: s0 = v36.p0
    val v38: Vector[Vector[Double]] = v94.p1
    val v89: Vector[Double] = v38(2)
    val v150: Double = v89(0)
    v150
  }
  def benchmark(): Unit = {
