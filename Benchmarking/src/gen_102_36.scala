...
object Gen extends App {
  ...
  @noinline
  def f0(v0: s1, v1: Vector[s2], v2: Vector[Vector[s7]], v3: Vector[s5], v4: Vector[s6], v5: Vector[s4], v6: Double): Double = {
    val v24: Double = v6 + v6
    val v13: Double = f79(v6)
    val v34: Double = v6 / v24
    val v50: Double = v13 + v6
    val v163: Double = v34 / v50
    val v172: Double = v13 / v163
    v172
  }
  def benchmark(): Unit = {
