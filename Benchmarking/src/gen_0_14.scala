...
object Gen extends App {
  ...
  @noinline
  def f0(v0: Vector[s4], v1: Vector[s5], v2: Double): Double = {
    val v4: s4 = v0(0)
    val v15: s4 = v0(0)
    val v11: s2 = v4.p0
    val v29: Vector[s0] = v11.p0
    var v24: Vector[s0] = v29
    val v16: s2 = v15.p0
    val v62: s0 = v24(0)
    val v83: Vector[Vector[Double]] = v62.p0
    val v81: Vector[s0] = v16.p0
    var v85: Vector[s0] = v81
    val v137: Vector[Double] = v83(1)
    val v123: s0 = v85(0)
    val v110: Double = v137(0)
    v24 = v85
    v24 = v24.updated(0, v123)
    v110
  }
  def benchmark(): Unit = {
