...
object Gen extends App {
  ...
  @noinline
  def f0(v0: s9, v1: Vector[Vector[s4]], v2: Double): Double = {
    val v4: Vector[s4] = v1(1)
    val v8: s4 = v4(0)
    val v7: s4 = v0.p0
    val v9: Vector[Double] = Vector(v2, v2, v2)
    val v26: Vector[s0] = v7.p0
    var v30: Vector[s0] = v26
    val v38: Vector[s0] = v8.p0
    val v23: s0 = v30(0)
