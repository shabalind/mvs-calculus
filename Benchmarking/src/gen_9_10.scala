...
object Gen extends App {
  ...
  def f2(v0: s0): s0 = {
    ...
    val v41: Vector[Vector[Vector[Double]]] = Vector(v11)
    v8 = v8.copy(p0 = v5)
    v8 = v8.copy(p0 = v12)
