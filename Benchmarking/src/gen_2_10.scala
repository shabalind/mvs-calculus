...
object Gen extends App {
  ...
  def f4(v0: s0): s0 = {
    ...
    val v8: Double = v5(0)
    val v19: Vector[Vector[Vector[Double]]] = Vector(v6)
    val v37: Vector[Vector[Double]] = v0.p1
    var v29: Vector[Vector[Double]] = v14
    val v20: s0 = s0(v29, v37)
    val v16: Vector[Double] = v6(1)
    val v57: Vector[Vector[Double]] = v20.p0
    val v30: s0 = s0(v6, v3)
    val v13: Vector[Vector[Double]] = v30.p1
    val v31: Vector[Double] = v29(1)
    val v28: Vector[Vector[Double]] = v19(0)
    var v55: Double = v8
    v14 = v14.updated(1, v16)
    val v21: Vector[Double] = v28(1)
    v29 = v29.updated(0, v21)
    val v34: Vector[Double] = v12(0)
    val v107: Vector[Vector[Double]] = v0.p0
    v14 = v14.updated(1, v31)
    var v61: s0 = v30
    v61 = v61.copy(p0 = v57)
    val v98: Vector[Vector[Double]] = v20.p0
    var v185: Vector[Double] = v34
    val v73: Vector[Double] = v98(0)
    v61 = v61.copy(p0 = v6)
    v61 = v61.copy(p0 = v29)
    val v83: Double = v55 * v55
    v61 = v61.copy(p0 = v107)
    v61 = v61.copy(p1 = v13)
    v185 = v185.updated(0, v83)
    v29 = v29.updated(0, v185)
    v29 = v29.updated(1, v73)
    v61
  }
