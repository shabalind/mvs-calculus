...
object Gen extends App {
  ...
  @noinline
  def f0(v0: Vector[Vector[s3]], v1: Vector[s4], v2: Double): Double = {
    val v5: Double = v2 + v2
    var v11: Double = v5
    var v9: Double = v11
    v11 = v5
