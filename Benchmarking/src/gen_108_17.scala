...
object Gen extends App {
  ...
  @noinline
  def f0(v0: s2, v1: Vector[Vector[s9]], v2: Vector[Vector[s5]], v3: Vector[Vector[s1]], v4: Double): Double = {
    val v8: s1 = v0.p1
    val v11: s1 = f4(v8)
    val v22: s0 = v11.p0
    var v37: s0 = v22
    val v16: Vector[Vector[Double]] = v37.p0
    val v31: Vector[Vector[Double]] = v22.p1
    val v51: Vector[Double] = v16(0)
    val v47: Double = v51(0)
    v37 = v37.copy(p1 = v31)
    v47
  }
  def benchmark(): Unit = {
