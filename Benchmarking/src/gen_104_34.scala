...
object Gen extends App {
  ...
  def f72(v0: s3, v1: s4): s3 = {
    val v72: Vector[s3] = v1.p1
    val v63: s3 = v72(0)
    v63
  }
  @noinline
  def f0(v0: s3, v1: s2, v2: s4, v3: Double): Double = {
    val v12: s3 = f72(v0, v2)
    val v23: Vector[s0] = v12.p0
    val v39: s0 = v23(2)
    val v70: Vector[Vector[Double]] = v39.p0
    val v64: Vector[Double] = v70(0)
    val v144: Double = v64(0)
    val v78: Double = v144 + v144
    v78
  }
  def benchmark(): Unit = {
