...
object Gen extends App {
  ...
  @noinline
  def f0(v0: s2, v1: s0, v2: s0, v3: Double): Double = {
    val v8: Vector[Vector[s1]] = v0.p1
    var v4: Vector[Vector[s1]] = v8
    val v7: Vector[s1] = v4(1)
    v4 = v4.updated(0, v7)
    val v5: s1 = v7(0)
    val v21: s0 = v5.p2
    v4 = v4.updated(0, v7)
    v4 = v4.updated(1, v7)
    val v13: Vector[Vector[Double]] = v21.p2
    val v42: Vector[Double] = v13(0)
    v4 = v8
    val v30: Double = v42(0)
    val v66: Double = v30 + v30
    val v47: Double = v30 * v66
    var v118: Double = v47
    v118
  }
  def benchmark(): Unit = {
    ...
    val v1: s0 = s0(Vector(Vector(72.0), Vector(73.0), Vector(74.0)), Vector(Vector(75.0), Vector(76.0), Vector(77.0)), Vector(Vector(78.0), Vector(79.0)))
    val v2: s0 = s0(Vector(Vector(80.0), Vector(81.0), Vector(82.0)), Vector(Vector(83.0), Vector(84.0), Vector(85.0)), Vector(Vector(86.0), Vector(87.0)))
    val v3: Double = 88.0
    val start = nanoTime()
