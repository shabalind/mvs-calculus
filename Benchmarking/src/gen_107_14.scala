...
object Gen extends App {
  ...
  @noinline
  def f0(v0: s0, v1: Vector[Vector[s0]], v2: Vector[Vector[s0]], v3: s4, v4: s4, v5: Double): Double = {
    val v7: Vector[Vector[Double]] = v0.p0
    var v10: Double = v5
    var v20: Vector[Vector[Double]] = v7
    val v8: Vector[Double] = v20(0)
