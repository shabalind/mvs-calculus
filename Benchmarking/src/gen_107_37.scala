...
object Gen extends App {
  ...
  @noinline
  def f0(v0: Vector[Vector[s3]], v1: s5, v2: Vector[Vector[s4]], v3: Double): Double = {
    val v5: Vector[s4] = v2(2)
    val v11: s4 = v5(0)
    val v9: s2 = v11.p0
    val v12: Vector[s1] = v9.p0
    val v14: s1 = v12(1)
    val v19: s0 = v14.p0
    val v60: Vector[Vector[Double]] = v19.p0
    var v48: Vector[Vector[Double]] = v60
    val v38: Vector[Double] = v48(0)
    val v82: Double = v38(0)
    v82
  }
  def benchmark(): Unit = {
    val v0: Vector[Vector[s3]] = Vector(Vector(s3(s0(Vector(Vector(0.0)), Vector(Vector(1.0), Vector(2.0))), Vector(Vector(s0(Vector(Vector(3.0)), Vector(Vector(4.0), Vector(5.0)))), Vector(s0(Vector(Vector(6.0)), Vector(Vector(7.0), Vector(8.0))))))))
