...
object Gen extends App {
  ...
  def f5(v0: Double): Double = {
    ...
    var v18: Double = v0
    var v22: Double = v14
    val v16: Double = v18 / v3
    v1 = v16
    val v25: Vector[Double] = Vector(v8, v18, v5, v14)
    var v15: Vector[Double] = v25
    var v24: Vector[Double] = v15
    v24 = v24.updated(2, v22)
    var v53: Vector[Double] = v24
    val v47: Double = v53(1)
    v15 = v15.updated(3, v0)
    val v63: Double = v53(3)
    v24 = v24.updated(2, v47)
    v63
  }
  @noinline
  def f0(v0: Vector[Vector[s1]], v1: Vector[s4], v2: Double): Double = {
    val v6: Double = f5(v2)
    val v3: Double = f5(v6)
    val v10: Double = f5(v3)
    val v12: Double = f5(v10)
    val v29: Double = f5(v12)
    v29
  }
  def benchmark(): Unit = {
