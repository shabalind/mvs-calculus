...
object Gen extends App {
  ...
  def f0(v0: s2, v1: Double): Double = {
    ...
    val v6: s1 = v3(0)
    val v10: Vector[Vector[s0]] = v6.p1
    val v15: Vector[s0] = v10(1)
    val v40: s0 = v15(0)
    val v21: Vector[Vector[Double]] = v40.p1
    val v34: Double = v1 + v1
    val v53: Vector[Double] = v21(1)
    val v31: Double = v34 + v34
    val v102: Double = v31 / v31
    val v215: Double = v53(0)
    val v165: Double = v102 / v1
    val v176: Double = v215 * v165
    v176
  }
  def benchmark(): Unit = {
