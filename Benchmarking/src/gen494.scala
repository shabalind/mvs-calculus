...
object Gen extends App {
  ...
  def f11(v0: s0): s0 = {
    ...
    v6 = v6.updated(1, v2)
    var v5: Vector[Vector[Double]] = v8
    v6 = v6.updated(0, v2)
    val v10: Vector[Vector[Double]] = v1.p4
    v4 = v4.copy(p1 = v6)
    val v12: Vector[Vector[Double]] = v1.p2
    val v11: Vector[Vector[Double]] = v0.p5
    val v13: Vector[Vector[Double]] = v7.p0
    v1 = v1.copy(p1 = v11)
    v4 = v4.copy(p5 = v6)
    var v9: Vector[Vector[Double]] = v10
    v9 = v9.updated(0, v2)
    val v28: Vector[Vector[Double]] = v4.p0
    v5 = v5.updated(0, v2)
    v4 = v4.copy(p2 = v10)
    var v17: Vector[Double] = v2
    val v14: Vector[Vector[Double]] = v7.p4
    v1 = v1.copy(p3 = v3)
    val v19: Vector[Vector[Double]] = v7.p2
    val v20: Vector[Double] = v6(1)
    var v27: s0 = v0
    var v36: Vector[Vector[Double]] = v14
    val v43: Vector[Vector[Double]] = v0.p3
    v36 = v36.updated(0, v2)
    v6 = v6.updated(1, v20)
    var v49: Vector[Vector[Double]] = v43
    var v33: Vector[Vector[Double]] = v5
    var v23: Vector[Vector[Double]] = v11
    val v24: Vector[Vector[Double]] = v1.p4
    var v25: Vector[Double] = v17
    val v22: Vector[Vector[Double]] = v7.p2
    val v26: Vector[Vector[Double]] = v27.p3
    v7 = v7.copy(p2 = v24)
    v4 = v4.copy(p5 = v5)
    var v65: s0 = v27
    val v54: Double = v2(0)
    val v72: Vector[Vector[Double]] = v65.p1
    v7 = v7.copy(p1 = v5)
    v27 = v27.copy(p0 = v36)
    var v37: Vector[Vector[Double]] = v12
    val v29: s0 = s0(v19, v49, v22, v5, v19, v23)
    var v51: Vector[Vector[Double]] = v37
    v27 = v27.copy(p3 = v26)
    val v59: Vector[Vector[Double]] = v29.p3
    val v50: Vector[Vector[Vector[Double]]] = Vector(v22, v9, v28, v24, v22, v28, v9)
    val v69: Vector[Vector[Double]] = v50(6)
    v51 = v51.updated(0, v2)
    val v80: Vector[Vector[Vector[Double]]] = Vector(v22, v13, v36, v13, v10, v51)
    v33 = v33.updated(1, v17)
    v27 = v27.copy(p4 = v9)
    val v67: Vector[Double] = v26(1)
    v33 = v49
    val v253: Vector[Vector[Double]] = v80(3)
    v65 = v65.copy(p2 = v69)
    v4 = v4.copy(p0 = v12)
    v27 = v27.copy(p1 = v72)
    v25 = v25.updated(0, v54)
    val v150: s0 = s0(v12, v26, v253, v33, v253, v6)
    ...
    v7 = v7.copy(p0 = v12)
    v65 = v65.copy(p3 = v59)
    var v145: Vector[Vector[Double]] = v28
    v4 = v4.copy(p0 = v22)
    v1 = v1.copy(p4 = v145)
    v150
  }
  def f9(v0: Vector[Vector[s0]]): Vector[Vector[s0]] = {
    val v7: Vector[s0] = v0(0)
    val v8: Vector[s0] = v0(1)
    var v13: Vector[Vector[s0]] = v0
    var v20: Vector[Vector[s0]] = v0
    v13 = v13.updated(0, v7)
    var v22: Vector[Vector[s0]] = v13
    v20 = v20.updated(0, v8)
    var v306: Vector[Vector[s0]] = v0
    v306 = v22
    var v156: Vector[Vector[s0]] = v306
    val v134: Vector[s0] = v20(0)
    v306 = v306.updated(0, v134)
    v156
  }
  def f5(v0: s0): s0 = {
    ...
    val v12: s0 = f11(v3)
    val v11: s0 = f11(v12)
    val v18: Vector[Vector[Double]] = v0.p4
    v3 = v3.copy(p4 = v18)
    val v24: Vector[Vector[Double]] = v14.p5
    val v46: s0 = f11(v11)
    v3 = v3.copy(p1 = v24)
    v46
  }
  @noinline
  def f0(v0: s1, v1: Vector[s1], v2: Vector[Vector[s1]], v3: s1, v4: Double): Double = {
    val v5: Vector[Vector[s0]] = v3.p5
    val v6: Vector[Vector[s0]] = f9(v5)
    var v9: Vector[Vector[s0]] = v6
    val v8: Vector[Vector[s0]] = v0.p5
    var v23: s1 = v3
    val v14: Vector[s0] = v23.p7
    val v10: Vector[s0] = v3.p3
    val v7: Vector[s1] = v2(0)
    val v18: Vector[s0] = v23.p7
    v23 = v23.copy(p2 = v18)
    val v21: Vector[s0] = v23.p7
    val v36: s1 = v7(0)
    val v22: s0 = v36.p4
    v23 = v23.copy(p4 = v22)
    v9 = v9.updated(1, v10)
    ...
    val v70: s0 = f5(v16)
    v23 = v23.copy(p0 = v10)
    val v34: Vector[s0] = v8(0)
    v9 = v9.updated(0, v34)
    v23 = v23.copy(p1 = v22)
    val v91: Vector[Vector[Double]] = v15.p2
    var v46: Vector[Vector[Double]] = v91
    val v97: Vector[Double] = v46(0)
    val v140: Vector[s0] = v23.p3
    val v104: Vector[Vector[Double]] = v70.p1
    v23 = v23.copy(p3 = v140)
    var v101: Vector[Double] = v97
    v23 = v23.copy(p1 = v15)
    v23 = v23.copy(p7 = v18)
    v23 = v23.copy(p5 = v9)
    v23 = v23.copy(p2 = v21)
    v46 = v46.updated(0, v101)
    val v124: Vector[Double] = v104(0)
    val v147: Double = v97(0)
    v46 = v46.updated(0, v124)
    v147
  }
  def benchmark(): Unit = {
