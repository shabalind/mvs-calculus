...
object Gen extends App {
  ...
  def f30(v0: s0): s0 = {
    var v2: s0 = v0
    val v1: Vector[s0] = Vector(v2, v2, v2, v2, v2)
  ...
  @noinline
  def f0(v0: s5, v1: Vector[Vector[s0]], v2: Vector[s4], v3: s4, v4: Double): Double = {
    val v5: s2 = v3.p0
    val v19: s1 = v5.p1
    var v13: s1 = v19
    ...
    v13 = v13.copy(p0 = v27)
    val v89: s0 = f30(v38)
    val v136: Vector[Vector[Double]] = v89.p1
    val v75: Vector[Double] = v136(1)
    val v93: Double = v75(0)
    v93
  }
  def benchmark(): Unit = {
