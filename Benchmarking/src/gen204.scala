...
object Gen extends App {
  ...
  def f53(v0: s0): s0 = {
    ...
    v7 = v7.copy(p0 = v4)
    var v22: s0 = v6
    val v20: Vector[Double] = v31(2)
    v7 = v7.copy(p1 = v11)
    v6 = v6.copy(p1 = v4)
    var v16: s0 = v6
    val v27: Vector[Vector[Double]] = v7.p1
    val v18: Vector[Double] = v1(2)
    v16 = v16.copy(p0 = v4)
    val v43: Vector[s0] = Vector(v22, v22, v22, v6, v7)
    val v25: Double = v20(0)
    val v24: Vector[Vector[Double]] = v6.p1
    ...
    val v41: s0 = v43(4)
    v22 = v22.copy(p0 = v1)
    val v39: Vector[Double] = v33(1)
    v22 = v22.copy(p0 = v28)
    val v44: Vector[Vector[Double]] = v30.p1
    v4 = v4.updated(2, v3)
    v22 = v22.copy(p0 = v44)
    val v36: Vector[Vector[Double]] = v16.p1
    var v65: s0 = v7
    var v117: s0 = v0
    val v47: Vector[Vector[Vector[Double]]] = Vector(v36, v21)
    val v45: Vector[Vector[Double]] = v117.p0
    v7 = v7.copy(p1 = v27)
    v7 = v7.copy(p0 = v33)
    v16 = v16.copy(p1 = v45)
    var v52: Vector[Double] = v3
    var v56: s0 = v41
    v22 = v22.copy(p1 = v45)
    val v53: s0 = v43(1)
    v22 = v22.copy(p0 = v12)
    v52 = v52.updated(0, v9)
    var v107: Vector[Vector[Vector[Double]]] = v47
    val v87: Vector[Vector[Double]] = v117.p1
    v30 = v30.copy(p1 = v87)
    v22 = v22.copy(p1 = v11)
    v52 = v52.updated(0, v32)
    v7 = v56
    val v108: Vector[Vector[Double]] = v117.p1
    val v112: Vector[Vector[Double]] = v107(0)
    v11 = v11.updated(0, v39)
    val v198: Vector[Vector[Double]] = v53.p1
    var v114: Vector[s0] = v43
    v117 = v117.copy(p1 = v24)
    var v80: Vector[s0] = v114
    v6 = v6.copy(p1 = v31)
    v52 = v52.updated(0, v32)
    v65 = v41
    v80 = v80.updated(3, v65)
    val v149: Vector[Vector[Double]] = v22.p0
    val v83: Vector[Vector[Double]] = v16.p0
    v6 = v6.copy(p1 = v83)
    v56 = v56.copy(p0 = v12)
    v6 = v6.copy(p1 = v198)
    var v254: Vector[s0] = v80
    v11 = v11.updated(2, v52)
    v6 = v6.copy(p0 = v112)
    v52 = v52.updated(0, v25)
    v65 = v65.copy(p1 = v108)
    val v154: s0 = v254(1)
    v16 = v16.copy(p0 = v149)
    v154
  }
  def f24(v0: s0): s0 = {
    var v4: s0 = v0
  ...
  @noinline
  def f0(v0: s1, v1: Vector[s7], v2: s5, v3: Double): Double = {
    var v5: s1 = v0
    val v6: s1 = f18(v5)
    val v8: s0 = v6.p2
    v5 = v5.copy(p0 = v8)
    ...
    var v9: s1 = v6
    val v14: s0 = f24(v8)
    val v11: Vector[s0] = v18.p3
    val v13: Vector[s0] = v0.p3
    val v24: Vector[Vector[Double]] = v8.p0
    v9 = v9.copy(p0 = v8)
    val v16: Vector[Double] = v24(2)
    val v12: Vector[s0] = v9.p3
    val v20: Vector[s0] = v18.p1
    v5 = v5.copy(p2 = v7)
    ...
    v5 = v5.copy(p3 = v11)
    val v95: s0 = f24(v8)
    val v36: Vector[Double] = v24(0)
    val v56: s0 = v20(1)
    var v41: Vector[s0] = v20
    v5 = v5.copy(p3 = v12)
    var v55: s0 = v30
    v5 = v5.copy(p1 = v41)
    val v106: Vector[Vector[Double]] = v56.p0
    v55 = v55.copy(p1 = v106)
    val v74: s0 = f24(v25)
    v5 = v5.copy(p3 = v11)
    v9 = v9.copy(p3 = v13)
    val v82: Double = v36(0)
    v41 = v41.updated(1, v74)
    v41 = v41.updated(0, v7)
    v55 = v95
    val v75: Vector[s0] = v9.p3
    v41 = v41.updated(1, v55)
    v55 = v55.copy(p1 = v106)
    v9 = v9.copy(p0 = v74)
    var v107: Double = v82
    var v246: Vector[s0] = v20
    val v94: Double = v15 - v107
    v5 = v5.copy(p1 = v246)
    v246 = v246.updated(1, v14)
    v5 = v5.copy(p3 = v75)
    v94
  }
  def benchmark(): Unit = {
