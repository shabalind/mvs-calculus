  ...
  struct s4 {
    ...
    s3 p1;
    s0 p2;
    s4(s3 v0, s3 v1, s0 v2): p0(v0), p1(v1), p2(v2) { }
  };
  struct s6 {
    s3 p0;
    s4 p1;
  ...
  double f0(const s1 &v0, const s6 &v1, const s4 &v2, const double &v3) {
    ...
    const std::vector<double> v100 = v40[0];
    const double v67 = v32[0];
    const double v192 = v100[0];
    const double v120 = v192 * v67;
    return v120;
  }
  int main() {
