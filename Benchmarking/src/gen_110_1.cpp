  ...
  struct s3 {
    std::vector<std::vector<s0>> p0;
    std::vector<s2> p1;
    s3(std::vector<std::vector<s0>> v0, std::vector<s2> v1): p0(v0), p1(v1) { }
  };
  struct s5 {
    s0 p0;
    s1 p1;
    s0 p2;
    s5(s0 v0, s1 v1, s0 v2): p0(v0), p1(v1), p2(v2) { }
  };
  struct s7 {
    s3 p0;
    std::vector<s1> p1;
  ...
  struct s9 {
    std::vector<s7> p0;
    std::vector<s5> p1;
    s9(std::vector<s7> v0, std::vector<s5> v1): p0(v0), p1(v1) { }
  };
  double f105(const double &v0) {
    const std::vector<double> v3 { v0, v0, v0 };
    const double v8 = v0 + v0;
    const double v6 = v8 / v0;
    std::vector<double> v1 = v3;
    v1[2] = v6;
    const double v11 = v1[0];
    double v12 = v11;
    const std::vector<double> v17 { v12 };
    const double v9 = v17[0];
    v1[0] = v9;
    return v9;
  }
  __attribute__((noinline))
  double f0(const std::vector<std::vector<s0>> &v0, const s9 &v1, const double &v2) {
    const std::vector<s0> v5 = v0[2];
    const s0 v4 = v5[0];
    double v7 = v2;
    const double v6 = f105(v7);
    const std::vector<std::vector<double>> v18 = v4.p0;
    const double v14 = f105(v6);
    const std::vector<double> v70 = v18[2];
