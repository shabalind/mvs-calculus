...
object Gen extends App {
  ...
  def f47(v0: Double): Double = {
    ...
    var v11: Double = v13
    var v28: Double = v0
    val v17: Vector[Double] = Vector(v14, v11, v14, v6, v10, v7, v12)
    val v35: Double = v17(4)
    var v25: Vector[Double] = v17
    v25 = v25.updated(3, v35)
    val v37: Vector[Vector[Double]] = Vector(v25, v25, v17)
    v25 = v25.updated(6, v13)
    v25 = v25.updated(2, v9)
    val v24: Vector[Double] = v37(1)
    v25 = v25.updated(5, v28)
    val v39: Double = v24(0)
    v25 = v25.updated(4, v35)
    v39
  }
  @noinline
  def f0(v0: s2, v1: Vector[s4], v2: Double): Double = {
    val v6: Double = f47(v2)
    v6
  }
  def benchmark(): Unit = {
