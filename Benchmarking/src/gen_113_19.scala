...
object Gen extends App {
  ...
  def f21(v0: s5): s5 = {
    var v6: s5 = v0
    val v4: Vector[s5] = Vector(v0, v6, v6)
    val v5: s5 = v4(1)
    val v2: s3 = v5.p0
    val v3: s1 = v5.p1
    val v9: s1 = v5.p1
    val v7: Vector[s0] = v9.p1
    v6 = v6.copy(p0 = v2)
    val v11: s0 = v7(1)
    v6 = v6.copy(p1 = v3)
    val v1: s3 = v5.p0
