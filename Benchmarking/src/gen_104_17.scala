...
object Gen extends App {
  ...
  def f53(v0: s0): s0 = {
    ...
    var v15: s0 = v3
    v3 = v3.copy(p2 = v8)
    val v22: Vector[Double] = v8(1)
    val v33: s2 = f80(v14)
    val v35: Vector[Vector[Double]] = v15.p2
    var v34: Vector[Vector[Double]] = v1
    val v29: Vector[Vector[Double]] = v4.p0
    v4 = v4.copy(p2 = v35)
    v3 = v3.copy(p1 = v1)
    val v48: s2 = f80(v33)
    v34 = v34.updated(1, v22)
    val v41: Vector[Vector[Double]] = Vector(v7, v22, v9, v7, v11, v7, v11)
    val v46: Vector[Double] = v41(0)
    v15 = v15.copy(p2 = v8)
    val v50: s2 = f80(v48)
    v15 = v15.copy(p1 = v34)
    v15 = v15.copy(p0 = v29)
    v34 = v34.updated(1, v46)
    v4 = v4.copy(p0 = v2)
    v4 = v4.copy(p2 = v8)
    val v64: s2 = f80(v50)
    v34 = v10
  ...
  @noinline
  def f0(v0: s11, v1: s9, v2: Vector[s4], v3: Double): Double = {
    val v5: s4 = v2(0)
    val v21: s2 = v5.p0
    val v15: s2 = f80(v21)
    var v13: s2 = v15
