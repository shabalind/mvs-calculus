...
object Gen extends App {
  ...
  @noinline
  def f0(v0: Vector[s1], v1: s0, v2: s3, v3: Vector[s2], v4: Double): Double = {
    val v5: Double = v4 / v4
    ...
    v6 = v6.copy(p0 = v7)
    v6 = v6.copy(p1 = v19)
    val v30: Vector[Double] = v19(2)
    val v54: Double = v5 - v4
    val v51: Double = v30(0)
    val v62: Double = v54 * v51
    v62
  }
  def benchmark(): Unit = {
    ...
    val v1: s0 = s0(Vector(Vector(45.0), Vector(46.0)), Vector(Vector(47.0), Vector(48.0), Vector(49.0)))
