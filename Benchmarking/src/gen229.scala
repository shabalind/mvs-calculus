...
object Gen extends App {
  ...
  def f70(v0: Double): Double = {
    ...
    var v1: Double = v4
    var v13: Double = v1
    val v21: Vector[Double] = Vector(v1, v0)
    val v20: Vector[Vector[Double]] = Vector(v21, v21, v21, v21)
    val v56: Vector[Double] = v20(2)
    var v31: Vector[Vector[Double]] = v20
    val v14: Double = v13 + v13
    val v27: Vector[Double] = v31(3)
    var v33: Vector[Double] = v21
    v31 = v31.updated(0, v21)
    v31 = v31.updated(2, v56)
    v31 = v31.updated(2, v33)
    v31 = v31.updated(1, v21)
    val v35: Double = v27(0)
    v33 = v33.updated(0, v14)
    var v57: Vector[Double] = v56
    v31 = v31.updated(3, v57)
    v35
  }
  @noinline
