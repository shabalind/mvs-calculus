...
object Gen extends App {
  ...
  def f38(v0: s3): s3 = {
    ...
    v7 = v7.copy(p0 = v1)
    v7 = v7.copy(p0 = v5)
    val v4: Vector[Vector[s1]] = v7.p1
    val v8: Vector[s1] = v4(0)
    v7 = v7.copy(p1 = v4)
    val v16: s1 = v8(0)
    val v10: s1 = v8(0)
    val v42: s0 = v1.p1
    val v26: Vector[Vector[Vector[s1]]] = Vector(v4, v4, v4)
    val v24: Vector[Vector[s1]] = v26(2)
    val v40: s0 = v10.p1
    v7 = v7.copy(p1 = v24)
    var v66: s3 = v0
    v66 = v66.copy(p0 = v16)
    val v196: s1 = s1(v42, v40)
    v66 = v66.copy(p0 = v196)
    v66
  }
  @noinline
  def f0(v0: s3, v1: Vector[s5], v2: Vector[s1], v3: Double): Double = {
    val v5: s3 = f38(v0)
    val v8: s3 = f38(v5)
    val v9: s1 = v8.p0
    val v4: s0 = v9.p0
    val v62: Vector[Vector[Double]] = v4.p1
    val v31: Vector[Double] = v62(2)
    val v29: Double = v31(0)
    var v41: Double = v29
    v41
  }
  def benchmark(): Unit = {
