...
object Gen extends App {
  ...
  def f3(v0: Double): Double = {
    ...
    var v6: Double = v0
    var v1: Double = v4
    val v5: Vector[Double] = Vector(v1, v4, v1, v0, v0, v6, v0)
