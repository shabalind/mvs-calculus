...
object Gen extends App {
  ...
  @noinline
  def f0(v0: Vector[s3], v1: s2, v2: Double): Double = {
    val v3: s2 = f13(v1)
    val v13: s1 = v3.p0
    val v8: s0 = v13.p1
