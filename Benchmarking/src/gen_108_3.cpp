  ...
  struct s4 {
    ...
    std::vector<s1> p3;
    s0 p4;
    s4(s0 v0, std::vector<s2> v1, s0 v2, std::vector<s1> v3, s0 v4): p0(v0), p1(v1), p2(v2), p3(v3), p4(v4) { }
  };
  __attribute__((noinline))
  double f0(const s1 &v0, const s0 &v1, const s4 &v2, const double &v3) {
    const s0 v6 = v2.p0;
    const std::vector<std::vector<double>> v8 = v6.p2;
    const std::vector<double> v9 = v8[0];
    const std::vector<double> v17 = v8[1];
    const double v15 = v17[0];
    const std::vector<double> v24 = v8[0];
    std::vector<double> v19 = v24;
    const double v61 = v19[0];
    v19[0] = v15;
    v19 = v9;
    return v61;
  }
