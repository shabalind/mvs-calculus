...
object Gen extends App {
  ...
  def f4(v0: Double, v1: Vector[s4]): Double = {
    var v57: Double = v0
    v57
  }
  @noinline
  def f0(v0: Vector[Vector[s0]], v1: Vector[Vector[s2]], v2: Vector[Vector[s4]], v3: Vector[s7], v4: s2, v5: Double): Double = {
    var v7: Double = v5
    val v13: Vector[s4] = v2(0)
    val v6: Double = f4(v5, v13)
    val v27: Double = f4(v7, v13)
    val v44: Vector[s4] = v2(0)
    val v33: Double = v27 / v7
    val v70: Double = f4(v6, v44)
    val v73: Double = f4(v6, v13)
    val v129: Double = f4(v73, v13)
    var v66: Double = v70
    val v99: Double = v66 - v129
    val v109: Double = f4(v33, v44)
    val v141: Double = f4(v99, v44)
    val v105: Double = v141 / v109
    v105
  }
  def benchmark(): Unit = {
