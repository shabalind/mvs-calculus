...
object Gen extends App {
  ...
  @noinline
  def f0(v0: Vector[s6], v1: Vector[Vector[s5]], v2: Double): Double = {
    val v8: s6 = v0(1)
    val v9: s0 = v8.p1
