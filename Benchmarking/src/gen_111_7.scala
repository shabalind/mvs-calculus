...
object Gen extends App {
  ...
  def f7(v0: Double): Double = {
    var v4: Double = v0
    val v2: Vector[Double] = Vector(v0, v4, v4)
    var v7: Double = v4
    var v5: Double = v7
