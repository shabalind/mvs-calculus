...
object Gen extends App {
  ...
  def f16(v0: Double): Double = {
    ...
    var v8: Double = v4
    var v14: Double = v8
    val v11: Double = v14 / v8
    var v25: Double = v11
    v25 = v1
    var v13: Double = v25
    v7 = v2
    val v16: Double = v7 * v13
    v16
  }
  @noinline
  def f0(v0: s1, v1: Vector[s2], v2: Vector[Vector[s0]], v3: Double): Double = {
    var v8: Double = v3
    v8 = v3
    v8 = v3
    val v92: Double = v8 * v8
    var v45: Double = v92
    var v83: Double = v3
    val v147: Double = f16(v83)
    v8 = v147
    v45
  }
  def benchmark(): Unit = {
