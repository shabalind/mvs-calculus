...
object Gen extends App {
  ...
  def f14(v0: Double): Double = {
    val v3: Vector[Double] = Vector(v0, v0, v0, v0, v0, v0, v0)
    var v2: Double = v0
    val v9: Double = v3(4)
