...
object Gen extends App {
  ...
  @noinline
  def f0(v0: Vector[Vector[s0]], v1: Vector[s4], v2: s6, v3: Double): Double = {
    var v29: Vector[Vector[s0]] = v0
    val v17: Double = v3 * v3
    val v19: Vector[s0] = v29(1)
    val v33: s0 = v19(0)
    val v52: Vector[Vector[Double]] = v33.p1
    var v58: Double = v17
    v29 = v29.updated(2, v19)
    val v41: Vector[Double] = v52(0)
    val v77: Vector[s0] = v29(0)
    val v118: Double = v58 - v17
    val v102: Double = v41(0)
    v29 = v29.updated(2, v77)
    v29 = v29.updated(0, v19)
    val v242: Double = v102 * v118
    v242
  }
  def benchmark(): Unit = {
