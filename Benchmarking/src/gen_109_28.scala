...
object Gen extends App {
  ...
  def f25(v0: Double): Double = {
    ...
    v1 = v6
    var v16: Double = v1
    val v27: Vector[Double] = Vector(v16, v8)
    val v30: Double = v27(0)
    v30
  }
  @noinline
  def f0(v0: Vector[s0], v1: s6, v2: s0, v3: Vector[s4], v4: Vector[s5], v5: Double): Double = {
    val v6: Double = f25(v5)
    var v103: Double = v6
    v103
  }
  def benchmark(): Unit = {
