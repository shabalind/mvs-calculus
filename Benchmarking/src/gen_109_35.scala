...
object Gen extends App {
  ...
  def f0(v0: Vector[s3], v1: Double): Double = {
    ...
    val v23: s0 = v3.p1
    val v41: Vector[Vector[Double]] = v23.p0
    val v107: Vector[Vector[Vector[Double]]] = Vector(v10, v41)
    var v98: Vector[Vector[Vector[Double]]] = v107
    val v145: Vector[Vector[Double]] = v98(0)
    val v138: Vector[Double] = v145(0)
    val v81: Double = v138(0)
    v81
  }
  def benchmark(): Unit = {
