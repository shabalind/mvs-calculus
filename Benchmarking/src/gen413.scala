...
object Gen extends App {
  ...
  def f15(v0: s0): s0 = {
    ...
    v2 = v2.updated(0, v1)
    var v17: s0 = v0
    val v21: Vector[Vector[Double]] = v17.p1
    val v38: Vector[Vector[Double]] = Vector(v11, v5, v1, v8)
    val v14: Vector[Vector[Double]] = v0.p0
    var v30: Vector[Vector[Double]] = v14
    v30 = v30.updated(0, v16)
    val v24: Vector[Double] = v38(1)
    v4 = v4.copy(p0 = v30)
    val v23: Vector[Vector[Double]] = v17.p0
    v2 = v2.updated(1, v11)
    v2 = v2.updated(0, v11)
    v2 = v2.updated(1, v11)
    val v40: Vector[Vector[Double]] = v4.p0
    v4 = v4.copy(p0 = v30)
    val v37: Vector[Vector[Double]] = Vector(v24, v8)
    v17 = v17.copy(p1 = v2)
    var v61: s0 = v4
    val v25: s0 = s0(v30, v3)
    ...
    val v35: s0 = s0(v14, v3)
    val v34: Vector[Vector[Double]] = v61.p0
    v61 = v61.copy(p0 = v14)
    val v51: Vector[Vector[Double]] = v4.p0
    val v43: Vector[Vector[Double]] = v4.p1
    v2 = v2.updated(0, v16)
    val v59: Vector[Vector[Vector[Double]]] = Vector(v33, v6, v2)
    v4 = v4.copy(p1 = v22)
    val v58: Vector[Vector[Double]] = v25.p0
    val v78: Vector[Vector[Double]] = v25.p1
    v30 = v30.updated(0, v1)
    v4 = v4.copy(p0 = v34)
    val v88: Vector[s0] = Vector(v4, v4, v4, v17, v25)
    val v91: Vector[Vector[Double]] = v0.p1
    val v74: Vector[Vector[Double]] = v0.p0
    var v98: Vector[Vector[Vector[Double]]] = v59
    val v84: Vector[Vector[Double]] = v98(2)
    val v71: s0 = v88(2)
    v17 = v17.copy(p0 = v14)
    val v123: Vector[Double] = v74(0)
    v4 = v4.copy(p1 = v37)
    val v63: Vector[Vector[Double]] = v71.p0
    v4 = v4.copy(p0 = v63)
    v17 = v17.copy(p0 = v51)
    v17 = v17.copy(p0 = v40)
    val v150: Vector[Vector[Double]] = v98(1)
    v4 = v4.copy(p1 = v33)
    val v297: Vector[Vector[Double]] = v35.p0
    var v111: Vector[Vector[Double]] = v43
    v2 = v2.updated(1, v123)
    val v80: Vector[Vector[Double]] = v0.p1
    v4 = v4.copy(p1 = v91)
    var v100: Vector[s0] = v88
    v61 = v61.copy(p1 = v33)
    v17 = v17.copy(p1 = v78)
    v98 = v98.updated(2, v111)
    v17 = v17.copy(p1 = v80)
    v61 = v61.copy(p1 = v150)
    v30 = v30.updated(0, v8)
    v17 = v17.copy(p0 = v58)
    v4 = v4.copy(p1 = v84)
    var v220: Vector[s0] = v100
    val v216: s0 = v220(2)
    v61 = v61.copy(p0 = v297)
    v61 = v61.copy(p0 = v14)
    v4 = v4.copy(p1 = v15)
    v220 = v220.updated(2, v71)
    v17 = v17.copy(p0 = v14)
    v216
  }
  @noinline
  def f0(v0: s5, v1: s0, v2: s6, v3: Double): Double = {
