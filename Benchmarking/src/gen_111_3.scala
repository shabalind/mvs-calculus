...
object Gen extends App {
  ...
  def f24(v0: s4, v1: s4): s4 = {
    val v22: Vector[s2] = v1.p0
    var v40: s4 = v0
    v40 = v40.copy(p0 = v22)
    v40
  }
  @noinline
  def f0(v0: Vector[Vector[s2]], v1: s10, v2: Double): Double = {
    val v6: s4 = v1.p0
    val v4: s4 = f24(v6, v6)
    val v5: s2 = v4.p1
    val v16: s0 = v5.p2
    ...
    val v46: Vector[Double] = v74(0)
    v34 = v34.copy(p1 = v74)
    v34 = v34.copy(p1 = v74)
    val v85: Double = v46(0)
    var v72: Double = v85
    v72
  }
  def benchmark(): Unit = {
